...
public class FabuzheController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		FabuzheEntity user = fabuzheService.selectOne(new EntityWrapper<FabuzheEntity>().eq("fabuzheyonghuming", username));
    ...
    public R register(@RequestBody FabuzheEntity fabuzhe){
    	...
    	FabuzheEntity user = fabuzheService.selectOne(new EntityWrapper<FabuzheEntity>().eq("fabuzheyonghuming", fabuzhe.getFabuzheyonghuming()));
		if(user!=null) {
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,FabuzheEntity fabuzhe, HttpServletRequest request){
        EntityWrapper<FabuzheEntity> ew = new EntityWrapper<FabuzheEntity>();
		PageUtils page = fabuzheService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, fabuzhe), params), params));
        return R.ok().put("data", page);
    }
